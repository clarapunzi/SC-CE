...
def main():
    ...
    parser.add_argument('--method', type=str, required=True, choices=['dice', 'ils', 'debug'],
    ...
    fig_name = os.path.join(
        "plots", dt_name,
        "distributions" + dt_name + "_" + cf_method + ("_latent" if cf_latent else "") + ".pdf"
    )
    plt.savefig(fig_name)
    print("Saved Figure at", fig_name)
    plt.show()
